      ...
      <tr valign="top">
        <td class="tdrline"><form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
          ...
          <div class="dataDiv">
            ...
            <p><strong>帳號名稱</strong>:
            <input name="m_username" type="text" class="normalinput" id="m_username">
            <font color="#FF0000">*</font><br><span class="smalltext">請填入5~12個字元以內的小寫英文字母、數字及符號</span></p>
            <p><strong>使用密碼</strong>:
            <input name="m_passwd" type="password" class="normalinput" id="m_passwd">
            <font color="#FF0000">*</font><br><span class="smalltext">請填入5~10個字元以內的英文字母、數字及各種符號組合</span></p>
            <p><strong>確認密碼</strong>:
            <input name="m_passwdrecheck" type="password" class="normalinput" id="m_passwdrecheck">
            <font color="#FF0000">*</font> <br><span class="smalltext">請再輸入一次密碼</span></p>
            <hr size="2" />
            ...
            <span class="smalltext">西元格式(年/月/日)</span></p>
            <p><strong>電子郵件</strong>:
            <input name="m_email" type="text" class="normalinput" id="m_email">
            <font color="#FF0000">*</font><br><span class="smalltext">請確認該email無誤且可使用</span></p>
            <p><strong>個人FB</strong>:
            <input name="m_url" type="text" class="normalinput" id="m_url">
            <br><span class="smalltext">請填入網址</span></p>
            <p><strong>電　　話</strong>:
