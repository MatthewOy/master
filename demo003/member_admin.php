...
if(isset($_GET["keyword"])&&($_GET["keyword"]!="")){
  $query_keyMember = "SELECT * FROM memberdata WHERE m_username LIKE ? OR description LIKE ? ORDER BY m_id DESC";
	$stmt = $db_link->prepare($query_keyMember);
	$keyword = "%".$_GET["keyword"]."%";
	$stmt->bind_param("ss", $keyword, $keyword);

}

// 假設 $role 是從數據庫中檢索到的角色值
$role = 'admin';
// 將 role 的值存儲在 session 中
$_SESSION['role'] = $role;
      ...
      <tr valign="top">
        ...
        <div class="regbox">
          <p class="heading"><strong>會員系統</strong></p>
            ...
            <p align="center">
              <ol>
                <li><a href="member_adminupdate.php?id=<?php echo $mid;?>">[修改資料]</a></li> 
                <li><a href="?logout=true">[登出系統]</a></li> 
                <li><a href="board_admin.php">[進入留言板]</a></li>
                <li><a href="diary.php">[進入心情筆記]</a></li> 
              </ol>
